...
public class ApplicationConfig {
    ...
    public ModelMapper modelMapper() {
        ...
        modelMapper.addConverter(new Converter<LocalDateTime, LocalDate>() {
            @Override
            public LocalDate convert(MappingContext<LocalDateTime, LocalDate> mappingContext) {

                return mappingContext.getSource().toLocalDate();
            }
        });
